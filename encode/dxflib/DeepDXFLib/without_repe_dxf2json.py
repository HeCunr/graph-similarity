...
def extract_insert_features(entity):
    return {
        'insert_insert_point': to_2d(entity.dxf.insert),
        'scale': (entity.dxf.xscale, entity.dxf.yscale),
        'insert_rotation': entity.dxf.rotation
    }
...
def extract_text_features(entity):
    return {
        'text_insert_point': to_2d(entity.dxf.insert),
...
def extract_mtext_features(entity):
    return {
        'mtext_insert_point': to_2d(entity.dxf.insert),
...
def extract_circle_features(entity):
    return {
        'circle_center': to_2d(entity.dxf.center),
...
def extract_arc_features(entity):
    return {
        'arc_center': to_2d(entity.dxf.center),
        'arc_radius': entity.dxf.radius,
...
if __name__ == "__main__":
    ...
    output_json_path = r'C:\srtp\encode\data\dxf_json\1_2.json'  # 输出 JSON 文件路径
