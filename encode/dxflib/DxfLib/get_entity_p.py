...
def extract_solid_features(entity):
    return {
        'points': [
            (entity.dxf.vtx0.x, entity.dxf.vtx0.y),  # 仅提取X和Y坐标
...
def extract_spline_features(entity):
    return {
        ...
        'control_points': [(point[0], point[1]) for point in entity.control_points],  # 提取元组中的X和Y坐标
...
if __name__ == "__main__":
    file_path =  r'C:\srtp\241101\TRAIN\10L185150DCE Rev0_3.dxf'  # 请替换为您的DXF文件路径
