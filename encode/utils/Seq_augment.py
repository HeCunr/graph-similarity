...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Seq数据增强脚本")
    parser.add_argument("--input_dir", type=str, default=r"/home/vllm/encode/data/Seq/augu1",help="输入目录，包含原始 .h5 文件")
    parser.add_argument("--output_dir", type=str, default=r"/home/vllm/encode/data/Seq/augu2",help="输出目录，保存增强后的 .h5 文件")
