...
parser.add_argument('--data_dir', type=str, default=r'/mnt/share/DeepDXF_CGMN/encode/data/CFG', help='root directory for the data set')
parser.add_argument('--dataset', type=str, default="OpenSSL", help='indicate the specific data set')
parser.add_argument('--graph_size_min', type=int, default=10, help='min node size for one graph ')
parser.add_argument('--graph_size_max', type=int, default=10, help='max node size for one graph ')
parser.add_argument('--graph_init_dim', type=int, default=11, help='init feature dimension for one graph')
...
parser.add_argument('--log_path', type=str, default=r'/mnt/share/DeepDXF_CGMN/encode/logs/CGMN_logs/', help='path for log file')
