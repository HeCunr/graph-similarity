...
class GeomEncoderStack(nn.Module):
    """
    多层堆叠的 (MPNN + Aggregator)，示例节点从 2048 -> 1024 -> 256 -> 64，
    ...
    def __init__(self, args, d_model=256):
        super().__init__()
        # 这里 d_model = 256
        # 前三层使用 GeomEncoderBlock，每层 (aggregator) 会让节点数缩减:
        #   2048 -> 1024 -> 256 -> 64
        # 而特征维度(即 d_model)不变，均为 256
        self.blocks = nn.ModuleList([
            GeomEncoderBlock(d_model, in_nodes=2048, out_nodes=1024),
